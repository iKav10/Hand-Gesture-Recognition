...
#Detect hands from HTM file.

detector = htm.handDetector(maxHands=1, detectionCon=0.85, trackCon=0.8)

#access System audio files.
...
#define range of sound captured by webcam.
minVol = -63
maxVol = volRange[1]
print(volRange)
hmin = 50
...
#Id's of tips of fingr points.
tipIds = [4, 8, 12, 16, 20]
mode = ''
active = 0

#Failsafe for interacting with system.
...
while True:
   ...
   # print(lmList)
    ...
    if len(lmList) != 0:
      ...
      #  When fingers form a fist. [thumb, index, middle, ring, pinky]
